...
\begin{figure}
  \begin{centering}
    \includegraphics[scale = 0.2, trim = {7.5cm 4cm 5cm 5cm}]{images/033_scenarios_tab.png}
...
\begin{figure}
  \begin{centering}
    \includegraphics[scale = 0.2, trim = {7.5cm 4cm 5cm 5cm}]{images/034_educ_app.png}
...
\begin{figure}
  \begin{centering}
    \includegraphics[scale = 0.2, trim = {7.5cm 4cm 5cm 5cm}]{images/036_obtain_code.png}
...
To edit a categorical value, users can click on a small drop-down button in the cell which is to be edited. The table recognizes categorical variables and will then provide a menu where the desired value is to be selected. With numeric variables, users can select the cell and then input the value they wish to make predictions with. \par
Unfortunately, this also means that in numeric cases, the user is able to specify a value which is not in the original variables' range. In the case of \li{cnorm_model}, this could mean that one tries to make predictions for incomes in the year \li{2050}, which is not remotely in the scope of the original variable \li{year}. To circumvent the unresponsible usage of model predictions, bamlss.vis will display a warning pop-up message with the \enquote{scenario} where values were specified which are out of the original variables range (Appendix: Figure \ref{warning_popup}).
...
\begin{figure}
  \begin{centering}
    \includegraphics[scale = 0.45, trim = {1cm 0cm 1cm 3cm}]{images/038_warning_popup.png}
  \caption{Scenario data tab.}
  \label{warning_popup}
  \end{centering}
\end{figure}
