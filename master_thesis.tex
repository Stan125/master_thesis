...
\begin{equation}
  blabla
\end{equation}
% Saturday: In Basis Function form an effect looks like this:
% Saturday: But as already said bamlss has more effects. z.b. without basis structure


% the visualisation framework introduced in this thesis will be based on bamlss
