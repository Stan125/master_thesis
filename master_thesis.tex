...
\begin{figure}
  \begin{centering}
    \includegraphics[scale = 0.2, trim = {7.5cm 4cm 5cm 5cm}]{images/039_influence_graph.png}
...
\begin{figure}
  \begin{centering}
    \includegraphics[scale = 0.2, trim = {7.5cm 4cm 5cm 5cm}]{images/0310_influence_graph_qualitative.png}
  ...
  \end{centering}
\end{figure}
In Figure \ref{influence_graph_qualitative}, the x-axis again depicts the selected variable, \li{race}, with its possible outcomes \li{1.White} to \li{4. Other}. Every outcome displays five bars, one for each covariate combination specified in the \enquote{Scenarios} tab. % So in essence this displays influence of race depending on education. we can see that the effect of education is greather than the race one...
