...
\begin{figure}
  \begin{centering}
    \includegraphics[scale = 0.8]{images/10_wage_plot.pdf}
...
When a model with discrete observations is specified in the \enquote{Overview} tab, it is automatically recognized by bamlss.vis using the function \li{is.discrete()}. The overall structure of the application does not change, but the graphs are displayed differently. 
...
\begin{figure}[ht]
  \begin{centering}
    \includegraphics[scale = 0.2, trim = {7.5cm 4cm 5cm 5cm}]{images/035_educ_app_cdf.png}
